...
\newpage
\newpage
** HACER [4/9] Interfaz de aplicación (API)
...
Esta clase es parámetro que toma Loop en la función de repetición repeatFunction. Contiene una ParametersMap que es donde los Loops irán depositando sus valores actuales en cada vuelta que dén. Su constructor público acepta un puntero a una función de la forma =void miFuncion(ParametersMap* params)= para ser ejecutada en cada hoja del arbol de posibilidades desplegado por la cadena de bucles, pero se puede extender la clase para reimplementar =__executeImpl()= y usar definir otro constructor con cualquier número de parámetros que ésa función puede tomar como entradas y/o salidas adicionales si es que no es suficiente o no resulta cómodo hacerlo con el mapa de parámetros.
...
**** HACER [[apiTestclass][Test]]
#+LaTeX: \label{apiTestclass}
**** HACER <<<ChronoPlotter>>>
**** HACER <<<TaskPlotter>>>
*** HACER Test
Sólo comentar un poquillo por encima.
\newpage
...
/home/jtimon/workspace/preann/output/data/
/home/seth/tmp/preann/output/data/
...
[  Esta sección la estaba dejando un poco hasta que tenga terminadas las de diseño y manual del programador en las que estoy trabajando ahora. De todas formas, para el aprendizaje me parece más complicado discutir los resultados que para el rendimiento. 
La activación sigmoide bipolar para OR aprende más despacio al principio pero consigue los mejores resultados. No se me ocurre por qué es misma es la mejor en todo momento para AND o por qué la identidad (lineal) es la mejor para XOR. La motivación principal en este caso es demostrar que las funciones de escalón pueden conseguir resultados comparables.]
...
%%%%%%%% Algoritmos genéticos (adicional)
