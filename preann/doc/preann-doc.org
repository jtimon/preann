...
La arquitectura CUDA contempla un conjunto de multiprocesadores SIMT (una instrucción, múltiples hilos) con memoria compartida interna.
...
\end{thebibliography}
* TODO [0/3] Ediciones menores
- [ ] Poner imagenes en parte CUDA
- [ ] TODOs en experimentación
- [ ] Documentación del código
	  TODO mirar si hay que dejarlo aparte o se puede meter sin estropear el indice
      #   +LaTeX: \subimport{doxygen/latex/}{refman.tex}


* Footnotes

[fn:juegosEstrategiaAbstrac] http://en.wikipedia.org/wiki/Abstract_strategy_game
