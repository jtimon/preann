...
\newpage
* TODO Dise\~no e implementaci\'on [1/3]
  #+LaTeX: \label{diseno}
...
** DONE Dise\~no del algoritmo gen\'etico 
...
** TODO Interfaz del programador [0/3]
  #+LaTeX: \label{disenoInterfProgr}
*** TODO Guia de instalaci\'on
*** TODO Uso general
*** TODO Interfaces extensibles
\newpage
