...
\newpage
* TODO [0/3] An\'alisis del problema
#+LaTeX: \label{analisis}
** TODO [0/2] Objetivos
#+LaTeX: \label{anaObjetivos}

*** TODO [/] Implementación de la librería
...
*** TODO Estructura de las redes neuronales
...
*** TODO Estructuras para algoritmos genéticos
...
\end{thebibliography}
* TODO [0/8] Cosas por hacer desperdigadas
...
* TODO [0/5] Cosas por hacer código
