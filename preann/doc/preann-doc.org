...
** HACER Fortalezas y deficiencias
...
\newpage
* HACER [0/3] An\'alisis del problema
#+LaTeX: \label{analisis}
** HACER [0/2] Objetivos
#+LaTeX: \label{anaObjetivos}

*** HACER [/] Implementación de la librería
#+LaTeX: \label{anaObjetivosLib}
...
*** HACER Investigación
#+LaTeX: \label{anaObjetivosInvest}
...
\newpage
** HACER Especificaciones de la librería a implementar
#+LaTeX: \label{anaEspec}

Como se definió en la sección \ref{anaObjetivosLib}, la librería debe poder construir redes neuronales de cualquier topología y, al mismo tiempo, debe poder ser paralelizada usando diferentes tecnologías. Además, en la sección \ref{anaObjetivosInvest} establecimos que las neuronas pueden ser de varios tipos (binarias, bipolares y reales). 
...
Primero se describirán las clases fachada y el resto de clases utilizadas para la implementación de las redes neuronales en la sección \ref{anaEspecRedes}. Las implementaciones concretas de las fachadas para la factoría se describirán con más detalle en la sección [TODO decidir dónde: diseño, paralelizaciones, extensibilidad]. En la sección \ref{anaEspecGenetic} especificaremos de forma general las clases destinadas a la implementación del algoritmo genético y cómo se relacionan con las clases de las redes neuronales. Finalmente, en la sección \ref{anaEspecLoop} se describen las utilidades destinadas a probar la librería y medir su eficiencia, tanto en términos de rendimiento computacional como en términos de aprendizaje. Este último componente debe poder generar gráficas comparativas y ser suficientemente extensible para adaptarse a las necesidades del proyecto. 

*** HACER Estructura de las redes neuronales
#+LaTeX: \label{anaEspecRedes}
...
#+LaTeX: \label{anaEspecGenetic}

*** HACER Utilidades para la experimentación
#+LaTeX: \label{anaEspecLoop}

* HACER Consideraciones generales de diseño
#+LaTeX: \label{diseno}
...
* REVISAR [2/3] Paralelizaciones en las redes neuronales
...
*** REVISAR Modelo de programación
...
El kernel más simple para hacer una reducción como esta es

*** HACER Paralelizar las salidas
#+LaTeX: \label{disenoParalCUDAsal}
*** HACER Matriz de pesos invertida
...
** REVISAR Tareas de clasificaci\'on
...
** REVISAR Juegos de estrategia abstractos
...
\end{thebibliography}
* HACER [0/8] Cosas por hacer documentación
...
* HACER [0/5] Cosas por hacer código
- [ ] ¿Pasar Dummy a factory o a loopTest?
- [ ] CUDA reduction malo
- [ ] CUDA salidas malo
- [ ] Revisar todas las impl CUDA
- [ ] Guardar/Cargar a través de Interface y main de prueba (hasta nivel Population)
* Footnotes
