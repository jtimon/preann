...
\newpage
** MODIFICAR [0/4] Algoritmos gen\'eticos
...
*** HACER Algoritmo genético estándar y variaciones
#+LaTeX: \label{basTeoGenetEstan}
*** Operadores genéticos
**** HACER Operadores de selección
#+LaTeX: \label{basTeoGenetSel}
**** HACER Operadores de cruce
...
** HACER [0/15] General
- [ ] Modificar Teoría GA
- [ ] Más bibliografía GANN (incluir GANN)
- [ ] Hacer API
...
\bibitem{DeJong88} \textsc{K. De Jong}: \emph{Learning with genetic algorithms: An overview}. Mach Learning, vol. 3, pp. 121-138 (1988).
...
\bibitem{Merelo2012} \textsc{Juan J. Merelo Guervós}: \emph{Informática evolutiva: Algoritmos genéticos}. Documento
 técnico, Universidad de Granada, 2012. http://geneura.ugr.es/~jmerelo/ie/ags.htm
