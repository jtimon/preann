...
void GenericPlotter::plotAveraged(GenericPlotFunctionPtr func, std::string title, RangeLoop* xToPlot, string yLabel,
                        Loop* averagesLoop)
{
...
void GenericPlotter::plotFiles(GenericPlotFunctionPtr func, std::string title, RangeLoop* xToPlot, string yLabel,
                     Loop* filesLoop)
{
    GenericPlotFillAction2 action(func, &parameters, title, &plotData, false);
