...
typedef enum
{
    BT_FLOAT, BT_BIT, BT_SIGN, BT_BYTE, BT_FLOAT_SMALL
} BufferType;
#define BUFFER_TYPE_DIM 5
typedef enum
{
...
typedef enum
{
    IT_C, IT_SSE2, IT_CUDA_REDUC0, IT_CUDA_REDUC, IT_CUDA_OUT, IT_CUDA_INV
} ImplementationType;
#define IMPLEMENTATION_TYPE_DIM 6
typedef enum
{
