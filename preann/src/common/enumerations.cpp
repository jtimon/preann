...
std::string Enumerations::binaryOperationToString(unsigned binaryOperation)
{
    ...
    string error =
            " Enumerations::binaryOperationToString BinaryOperation not found";
    throw error;
}
...
std::string Enumerations::crossoverLevelToString(unsigned crossoverLevel)
{
    ...
    string error =
            " Enumerations::crossoverLevelToString CrossoverLevel not found";
    throw error;
}

std::string Enumerations::crossoverAlgorithmToString(
        unsigned crossoverAlgorithm)
{
    ...
    string error =
            " Enumerations::crossoverAlgorithmToString CrossoverAlgorithm not found";
    throw error;
}
...
std::string Enumerations::resetAlgorithmToString(unsigned resetAlgorithm)
{
    ...
    string error =
            " Enumerations::resetAlgorithmToString resetAlgorithm not found";
    throw error;
}
...
std::string Enumerations::mutationAlgorithmToString(unsigned mutationAlgorithm)
{
    ...
    string error =
            " Enumerations::mutationAlgorithmToString MutationAlgorithm not found";
    throw error;
}
...
std::string Enumerations::implementationToString(unsigned implementationType)
{
    ...
    string error =
            " Enumerations::implementationToString ImplementationType not found";
    throw error;
}
...
std::string Enumerations::selectionAlgorithmToString(
        unsigned selectionAlgorithm)
{
    ...
    string error =
            " Enumerations::selectionAlgorithmToString SelectionAlgorithm not found";
    throw error;
