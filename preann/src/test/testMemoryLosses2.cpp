...
int main(int argc, char *argv[]) {
	...
	try {
		...
		loop = new EnumLoop("bufferType", ET_BUFFER, loop);
		loop = new EnumLoop("implementationType", ET_IMPLEMENTATION, loop);

		loop->repeatFunction(testBuffer2, &parametersMap);
