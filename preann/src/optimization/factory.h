...
public:
    ...
    static Buffer* newBuffer(FILE* stream,
            ImplementationType implementationType);

    static Buffer* newBuffer(Interface* interface,
            ImplementationType implementationType);
    static Buffer* newBuffer(Buffer* buffer,
            ImplementationType implementationType);
    static Buffer* newBuffer(unsigned size, BufferType bufferType,
            ImplementationType implementationType);
    static Connection* newConnection(Buffer* input, unsigned outputSize,
            ImplementationType implementationType);
    static Connection* newThresholds(Buffer* output,
            ImplementationType implementationType);
