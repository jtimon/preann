...
extern "C" int XMMbinario(void* bufferEntrada, unsigned numeroBloques,
        unsigned char* pesos);
extern "C" int XMMbipolar(void* bufferEntrada, unsigned numeroBloques,
        unsigned char* pesos);
extern "C" void XMMreal(void* bufferEntrada, unsigned numeroBloques,
