...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        linesLoop.addEnumLoop(RA_PER_INDIVIDUAL, new RangeLoop(Population::RESET_NUM, 1, 4, 1));
        linesLoop.addEnumLoop(RA_PROBABILISTIC, new RangeLoop(Population::RESET_PROB, 0.05, 0.20, 0.05));
