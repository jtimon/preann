...
void playGames(GoBoard* board, Individual* player, const string& playerName, int numGames) {
...
{
    cout << "=== PREANN Go Comparison ===" << endl << endl;
    ...
    try {
        ...
        cout << "========================================" << endl;
        cout << "NOTE: This will fail - computerEstimation() not implemented" << endl;
        cout << "Skipping heuristic test..." << endl << endl;
        ...
        cout << "NOTE: Playing NN vs NN (both random)" << endl;
        cout << "Skipping for now - needs NN vs NN mode..." << endl << endl;
        ...
        cout << "========================================" << endl;
        cout << "NOTE: Would test trained NN vs heuristic, but heuristic not implemented" << endl;
        cout << "Training successful - neural network evolved!" << endl << endl;
