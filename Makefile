...
OBJECTS = xmm32.o paralelLayer.o chronometer.o commonFunctions.o vector.o xmmVector.o layer.o cudaLayer.o xmmLayer.o neuralNet.o cudaNeuralNet.o task.o classificationTask.o individual.o main.o factory.o interface.o cudaVector.o cudaLayer2.o
...
layer.o : layer.h layer.cpp vector.o
	$(CXX) -c layer.cpp
cudaVector.o : cudaVector.h cudaVector.cpp vector.o paralelLayer.o
